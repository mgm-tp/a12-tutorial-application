...
import com.mgmtp.a12.workflows.engine.internal.serialization.ProcessVariableAfterDeserializationEvent;
...
public class ProcessVariableEncryptionHandler {
    ...
    @EventListener
    void handleDecryption(ProcessVariableAfterDeserializationEvent event) {
